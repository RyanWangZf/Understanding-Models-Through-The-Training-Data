...
class BinaryInceptionModel(GenericNeuralNet):
    ...
    def load_inception_weights(self):
        ...
        weights_path = '/home/radaimi/Documents/influence-release-master/inception/inception_v3_weights_tf_dim_ordering_tf_kernels_notop.h5'
        self.inception_model.load_weights(weights_path)


    def inference(self, input):
        print(self.img_side)
        self.inception_model = InceptionV3(include_top=False, weights='imagenet', input_tensor=tf.reshape(input, [-1, self.img_side, self.img_side, self.num_channels]))
